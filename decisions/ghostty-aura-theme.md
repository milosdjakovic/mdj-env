...
- **Catppuccin Latte and Mocha.** 2026-09-11 16:12, bfffe0e, replaced 2026-09-12. They shipped
  inside Ghostty, which left the stowed themes directory holding two owls nothing pointed at.
- **Night Owl and Light Owl on the two halves.** 2026-09-12 16:55, 6583047, replaced eight
...
- **`aura.theme` beside `aura`.** 2026-09-12 16:55, 70ccab5. Same palette, but a comment after
...
- **Aura's own terminal package as the source.** 2026-09-13 10:25, 8c94bc2. Four chromatic
...
bfffe0e. The terminal follows the appearance for the first time, Catppuccin pair, proved
against `validate-config` because a wrong name fails quietly at load.

### 2026-09-12 16:55

6583047 and 70ccab5. Owls replace Catppuccin, the broken Aura duplicate goes.

### 2026-09-12 17:03

9bde0e7. Aura takes the dark half back, Light Owl keeps light. Looked at rather than reasoned
about.

### 2026-09-13 10:25

8c94bc2, 9e30734. Aura from its palette table, all four variants carried.

### 2026-09-13 12:09

cf0e6da. Aura Light derived, both halves the same theme.

### 2026-09-13 12:33 and 13:49

061373e, f6a1c65. Neovim follows the same switch, the last layer still pinned to dark and pinned
