...
-- them, which reaches for one tool of its own. A need with nothing but the root behind it is
...
-- the same terms as for a plugin and the root reaches for that tool by no name.
return {
  needs = {
    tools = {
