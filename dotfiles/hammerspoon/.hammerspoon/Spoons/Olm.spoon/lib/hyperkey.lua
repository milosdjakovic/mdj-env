...
--- five of the build plan. It is a faithful copy, the colon methods are unchanged, so
--- assigning it to the HyperKey spoon global is a drop in. The original this was copied from
--- still lives at Spoons/HyperKey.spoon.
